...
class FullyConnected(BaseLayer):
    def __init__(self, input_size, output_size):
        ...
        # A zero matrix to store the gradients computed during backward pass.
...
# Encapsulation - It hides the internal implementation optimizer but still gives safe access.
